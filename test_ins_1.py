"""
    Instantincrement Autosell test
"""
...
print("\nBuyer1 tries to bid 50 but minbid is {}".format(item.auction_type[1]))
try:
    item.bid(buyer1,50)
...
print("\nBuyer2 tries to bid 1k")
try:
    item.bid(buyer2,1000)
except Exception as e:
    print("\nFailed with message: ",e)
print("\nitem_view: ", item.view())

print("\nBuyer1 tries to bid 1k more")
try:
    item.bid(buyer1,1000)
except Exception as e:
    print("\nFailed with message: ",e)
...
print("\nBuyer2 tries to bid 3k more, autosell action?")
try:
    item.bid(buyer2,3000)
except Exception as e:
    print("\nFailed with message: ",e)
