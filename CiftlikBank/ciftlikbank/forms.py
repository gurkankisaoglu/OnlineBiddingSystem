...
class SellItemForm(forms.Form):
    ...
    auction_type = forms.CharField(max_length=30,help_text='example: (increment,mindelta,instantsell, starting_bid) '
                                                            + '(decrement, period, delta, stop, starting_bid) '
                                                            + '(instantincrement, minbid, autosell, starting_bid is zero)')
